...
export async function getDailyAssistant(workspaceId: string): Promise<{ greeting: string; items: AssistantItem[]; actionCenter: AssistantItem[] }> {
  ...
  const items: AssistantItem[] = [
    { id: '1', type: 'scheduled', title: 'Bugün 4 paylaşım planlı.', detail: 'Instagram (2), LinkedIn (1), X (1)', actionLabel: 'Takvimi gör', actionRoute: '/takvim', priority: 1 },
    { id: '2', type: 'approval', title: '2 içerik onay bekliyor.', detail: 'Kahve Dükkanı — taslaklar', actionLabel: 'Onayla', actionRoute: '/taslaklar', priority: 1 },
    { id: '3', type: 'account', title: 'Instagram hesabınız yeniden bağlantı gerektiriyor.', detail: 'Token süresi dolmak üzere', actionLabel: 'Bağla', actionRoute: '/sosyal-hesaplar', priority: 2 },
    { id: '4', type: 'gap', title: 'Yarın içerik takviminizde boşluk var.', detail: 'AI ile plan önerisi alabilirsiniz', actionLabel: 'Plan öner', actionRoute: '/ai-planlayici', priority: 3 },
  ];
