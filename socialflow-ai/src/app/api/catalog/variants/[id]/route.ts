...
export const PATCH = apiRoute((r, { session, params }) => businessResponse(async () => ok(await updateVariant(session, params.id, await businessBody(r)))), { sessionCsrf: true, limit: 30 });
